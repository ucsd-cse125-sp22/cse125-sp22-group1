...
fn test_collision_with_self() {
    ...
    assert!(origin_cube.bounding_box.is_colliding(&origin_cube.bounding_box));
}
...
fn test_engulfed_collision() {
    ...
    assert!(big_origin_cube.bounding_box.is_colliding(&smol_origin_cube.bounding_box));
}
...
fn test_collision_on_corner() {
    ...
    assert!(origin_cube.bounding_box.is_colliding(&not_origin_cube.bounding_box));
}
...
fn test_noncollision_when_above_or_below() {
    ...
    assert!(!origin_cube.bounding_box.is_colliding(&high_cube.bounding_box));
    assert!(!origin_cube.bounding_box.is_colliding(&low_cube.bounding_box));
