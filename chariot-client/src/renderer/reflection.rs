...
fn constant_size_val(module : &naga::Module, const_handle : naga::Handle<naga::Constant>) -> Result<u64, &'static str> {
...
fn to_wgpu_tex_sample_type(scalar_kind : naga::ScalarKind) -> Result<wgpu::TextureSampleType, &'static str> {
    match scalar_kind {
...
fn to_wgpu_binding_type(module : &naga::Module, naga_type : &naga::TypeInner) -> Result<wgpu::BindingType, &'static str> {
    match naga_type {
        ...
        naga::TypeInner::Image { 
            ...
            naga::ImageClass::Depth { 
                multi
            } => Err("Depth not supported yet")
        },
        naga::TypeInner::Sampler { 
            comparison 
        } => Ok(wgpu::BindingType::Sampler(
 ...
 */ 
fn wgpu_vertex_type_attr(location : u32, ty: &naga::TypeInner) -> Result<wgpu::VertexAttribute, &'static str> {
    Ok(*match ty {
        naga::TypeInner::Scalar { 
            kind, 
            width 
